...
public class EmployeeConverter {
	...
	public static EmployeeVo toVo(Employee bo) {
		return new EmployeeVo(bo.getId(), bo.getFirstName(), bo.getLastName(), bo.getSalary(),bo.getEmail(),DataBaseFileConverter.toVo(bo.getDiplome()));
	}

	public static Employee toBo(EmployeeVo vo) {
		return new Employee(vo.getId(), vo.getFirstName(), vo.getLastName(), vo.getSalary(),vo.getEmail(),DataBaseFileConverter.toBo(vo.getDiplome()));
	}
